...
function AppRoutes() {
    ...
    if (!isAuthReady) {
        return (
            <div className="w-screen h-screen flex items-center justify-center bg-[#075e51]">
                <svg className="animate-spin h-12 w-12 text-[#EAB308]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
