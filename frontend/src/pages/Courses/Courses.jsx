...
export default function Courses() {
        ...
        <div className="flex-1 h-full overflow-y-auto custom-scrollbar pt-4 sm:pt-6 md:pt-[24px] px-4 sm:px-6 md:px-8 pb-20 w-full animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6 sm:mb-8">
                ...
                <div className="shadow-[0_1px_4px_rgba(58,63,143,0.08)] bg-white rounded-xl p-5 sm:p-6 border border-[#e0e2eb] flex flex-col items-center justify-center text-center col-span-1">
                    <h2 className="text-[20px] sm:text-[24px] leading-[1.3] tracking-[-0.01em] font-semibold text-[#222777] mb-4 self-start">Weekly Goal</h2>
                ...
                <div className="col-span-1 lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="shadow-[0_1px_4px_rgba(58,63,143,0.08)] bg-white rounded-xl p-5 sm:p-6 border border-[#e0e2eb] flex flex-col justify-between cursor-pointer hover:border-[#222777] transition-colors" onClick={() => setActiveView('seminars')}>
                        <div className="flex items-start justify-between mb-4">
                            <div className="p-2 bg-[#e0e0ff] rounded-lg text-[#222777]">
                                <span className="material-symbols-outlined">menu_book</span>
                            </div>
                            <span className="text-[12px] sm:text-[14px] leading-[1.4] font-medium text-[#00696e] bg-[#E6FBFC] px-2 py-[2px] rounded border border-[#61f4fd]/30">Active</span>
                        </div>
                        <div>
                            <p className="text-[28px] sm:text-[32px] leading-[1.2] tracking-[-0.02em] font-bold text-[#222777]">4</p>
                            <p className="text-[14px] sm:text-[16px] leading-[1.6] text-[#464651] flex items-center gap-1">Courses In Progress <span className="material-symbols-outlined text-[16px] text-[#00c2cb]">arrow_forward</span></p>
                        </div>
                    </div>
                    ...
                    <div className="shadow-[0_1px_4px_rgba(58,63,143,0.08)] bg-white rounded-xl p-5 sm:p-6 border border-[#e0e2eb] flex flex-col justify-between relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <div>
                                <p className="text-[28px] sm:text-[32px] leading-[1.2] tracking-[-0.02em] font-bold text-[#222777]">12</p>
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <section>
                    <div className="flex items-center justify-between mb-4 border-b border-[#e0e2eb] pb-1.5 sm:pb-1">
                        <h3 className="text-[20px] sm:text-[24px] leading-[1.3] tracking-[-0.01em] font-semibold text-[#222777] flex items-center gap-1.5">
                    ...
                    <div className="space-y-3 sm:space-y-2">
                        {/* List Item 1 */}
                        <div className="shadow-[0_1px_4px_rgba(58,63,143,0.08)] bg-white rounded-lg p-3 sm:p-4 border border-[#e0e2eb] flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 hover:border-[#222777]/30 transition-colors">
                            ...
                            <div className="w-full sm:w-auto mt-1 sm:mt-0 shrink-0">
                                <button onClick={() => setActiveView('workbook')} className="w-full sm:w-auto bg-[#3a3f8f] text-[#ffffff] px-6 py-2.5 sm:py-2 rounded-lg text-[13px] sm:text-[12px] leading-[1] font-semibold hover:bg-[#222777] transition-colors flex items-center justify-center gap-1 shadow-sm">
                                    Continue
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        ...
                        <div className="shadow-[0_1px_4px_rgba(58,63,143,0.08)] bg-white rounded-lg p-3 sm:p-4 border border-[#e0e2eb] flex gap-3 sm:gap-4">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded bg-[#e6e8f1] flex items-center justify-center text-[#222777] shrink-0">
                            ...
                            <button className="text-[#c7c5d3] hover:text-[#222777] self-start p-1 -mr-2">
            ...
            <div className="mb-5 sm:mb-6">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-2 sm:mb-1 gap-2 sm:gap-0">
                    ...
                    <div className="text-left sm:text-right">
                        <span className="font-mono text-[12px] sm:text-[14px] leading-[1.4] font-medium text-[#222777]">65% Complete</span>
                    </div>
                </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
                ...
                <aside className="w-full lg:w-64 flex-shrink-0">
                    <div className="shadow-[0_1px_4px_rgba(58,63,143,0.08)] bg-white rounded-lg p-4 sm:p-5 lg:sticky lg:top-[88px]">
                        ...
                        <ul className="space-y-1.5 sm:space-y-2">
                            <li>
                                <a href="#" className="flex items-start gap-2 group p-1.5 -ml-1.5 rounded hover:bg-[#f9f9ff]">
                                    <span className="material-symbols-outlined text-[#00696e] mt-[2px] text-[16px] sm:text-[18px]">check_circle</span>
                                    <span className="text-[14px] sm:text-[16px] leading-[1.6] text-[#464651] group-hover:text-[#222777] transition-colors">1. Introduction to Heuristics</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" className="flex items-start gap-2 group p-1.5 -ml-1.5 rounded hover:bg-[#f9f9ff]">
                                    <span className="material-symbols-outlined text-[#00696e] mt-[2px] text-[16px] sm:text-[18px]">check_circle</span>
                                    <span className="text-[14px] sm:text-[16px] leading-[1.6] text-[#464651] group-hover:text-[#222777] transition-colors">2. Identifying Bias</span>
                                </a>
                            </li>
                            <li className="bg-[#f1f3fc] -mx-2 sm:-mx-3 p-2 sm:p-2.5 rounded border-l-[3px] border-[#222777]">
                                <a href="#" className="flex items-start gap-2 pl-1">
                                    ...
                                    <span className="text-[14px] sm:text-[16px] leading-[1.6] text-[#222777] font-bold">3. Nuanced Data Applications</span>
                                </a>
                            </li>
                            <li>
                ...
                <div className="flex-1 max-w-3xl flex flex-col gap-5 sm:gap-6 pb-12">
                    ...
                    <div className="shadow-[0_1px_4px_rgba(58,63,143,0.08)] bg-white rounded-lg p-5 sm:p-6">
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            <label className="flex items-start sm:items-center gap-3 sm:gap-4 p-3 rounded border border-[#c7c5d3] hover:border-[#222777] hover:bg-[#f1f3fc] cursor-pointer transition-all">
                                <input type="radio" name="q1" className="text-[#222777] focus:ring-[#222777] w-4 h-4 border-[#c7c5d3] mt-1 sm:mt-0" />
                            ...
                            <label className="flex items-start sm:items-center gap-3 sm:gap-4 p-3 rounded border border-[#222777] bg-[#f1f3fc] cursor-pointer transition-all">
                                <input type="radio" name="q1" defaultChecked className="text-[#222777] focus:ring-[#222777] w-4 h-4 border-[#222777] mt-1 sm:mt-0" />
                                <span className="text-[14px] sm:text-[16px] leading-[1.4] sm:leading-[1.6] text-[#222777] font-bold">Rush hour localized congestion</span>
                            </label>
                            <label className="flex items-start sm:items-center gap-3 sm:gap-4 p-3 rounded border border-[#c7c5d3] hover:border-[#222777] hover:bg-[#f1f3fc] cursor-pointer transition-all">
                                <input type="radio" name="q1" className="text-[#222777] focus:ring-[#222777] w-4 h-4 border-[#c7c5d3] mt-1 sm:mt-0" />
                        ...
                        <div className="border border-[#c7c5d3] rounded-lg p-4 sm:p-5 bg-[#f9f9ff] flex flex-col items-center justify-center min-h-[180px] sm:min-h-[200px] relative">
                            ...
                            <div className="flex flex-col items-center gap-3 sm:gap-4 z-10">
                                <button className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white border-2 border-[#00696e] flex items-center justify-center shadow-[0_0_0_0_rgba(0,194,203,0.7)] animate-[pulse_1.8s_infinite_cubic-bezier(0.66,0,0,1)] hover:scale-105 transition-transform group">
                                    <span className="material-symbols-outlined text-[#00696e] text-[28px] sm:text-[32px] group-hover:text-[#222777] transition-colors">mic</span>
                                </button>
                    ...
                    <div className="shadow-[0_1px_4px_rgba(58,63,143,0.08)] bg-white rounded-lg p-5 sm:p-6">
                        ...
                        <textarea className="w-full bg-[#f1f3fc] border border-[#c7c5d3] rounded p-3 sm:p-4 text-[14px] sm:text-[16px] leading-[1.6] text-[#181c22] focus:outline-none focus:border-[#222777] focus:ring-1 focus:ring-[#222777] transition-colors shadow-sm resize-none" placeholder="Begin typing your strategy here..." rows="5"></textarea>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center sm:justify-end gap-3 sm:gap-4 mt-2 sm:mt-4 border-t border-[#c7c5d3] pt-5 sm:pt-6">
                        ...
                        <button onClick={() => setActiveView('learning-list')} className="w-full sm:w-auto px-6 py-2.5 sm:py-2 rounded bg-[#222777] text-white font-mono text-[13px] sm:text-[14px] leading-[1.4] font-medium hover:bg-[#3a3f8f] transition-colors shadow-md flex items-center justify-center gap-1.5">
        ...
        <div className="flex flex-col h-full w-full animate-in fade-in duration-300">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 md:px-8 border-b border-[#e0e2eb] bg-white shrink-0 shadow-sm z-10 gap-3 sm:gap-0">
                <div className="flex items-center gap-3 sm:gap-4">
                    <button onClick={() => setActiveView('learning-list')} className="text-[#777682] hover:text-[#222777] transition-colors flex items-center justify-center w-8 h-8 rounded-full hover:bg-[#f1f3fc] shrink-0">
                        <span className="material-symbols-outlined">arrow_back</span>
                    </button>
                    <h1 className="text-[20px] sm:text-[24px] font-bold text-[#222777]">Nearby Seminars</h1>
                </div>
                <div className="flex gap-2 w-full sm:w-auto ml-11 sm:ml-0">
                    <select className="flex-1 sm:flex-none bg-[#f9f9ff] border border-[#e0e2eb] rounded-md px-2 sm:px-3 py-1.5 text-[12px] sm:text-[13px] font-bold text-[#464651] outline-none cursor-pointer">
            ...
            <div className="flex flex-1 overflow-hidden h-full">
                {/* List Column */}
                <div className="w-full md:w-[400px] border-r border-[#e0e2eb] bg-[#f9f9ff] overflow-y-auto custom-scrollbar p-4 space-y-4 shrink-0 shadow-[1px_0_4px_rgba(0,0,0,0.05)] z-10 pb-20">
                    {/* Seminar Card 1 */}
                    <div className="bg-white border border-[#e0e2eb] rounded-xl p-4 sm:p-5 shadow-sm hover:border-[#222777] transition-colors cursor-pointer relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-1 h-full bg-[#00c2cb]"></div>
                        <div className="flex justify-between items-start mb-2 sm:mb-3">
                            <span className="bg-[#e6fbfc] text-[#006e73] font-mono text-[9px] sm:text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider flex items-center gap-1">
                        ...
                        <div className="flex items-center justify-between border-t border-[#e0e2eb] pt-3 sm:pt-4">
                            ...
                            <button className="bg-[#222777] text-white px-3 sm:px-4 py-1.5 rounded text-[11px] sm:text-[12px] font-bold shadow-sm hover:bg-[#3a3f8f] transition-colors">
                                Register
                            </button>
                        </div>
                    </div>
                ...
                <div className="hidden md:flex flex-1 bg-[#d7dae2] relative overflow-hidden items-center justify-center">
                    ...
                    <div className="absolute top-[40%] left-[45%] flex flex-col items-center cursor-pointer group z-10">
                        ...
                        <div className="w-6 h-6 bg-[#00c2cb] rounded-full border-2 border-white shadow-md flex items-center justify-center group-hover:scale-110 transition-transform">
    ...
    return (
        <div className="w-full h-[calc(100vh-64px)] bg-[#f9f9ff] overflow-hidden font-sans">
